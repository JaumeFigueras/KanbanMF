...
from src.api.v1 import board_notifications, boards, cards, checklists, labels, lists, users, ws
...
router.include_router(
    board_notifications.router, prefix="/boards/{board_id}/notifications", tags=["notifications"]
)
