const ca = {
  ...
  boards: {
    ...
    resetColorToDefault: 'Restableix el predeterminat',
    ...
    emailNotificationTitle: 'Les meves notificacions per correu',
    emailNotificationHint: 'Aquesta configuració és personal — activar-la només afecta els correus que reps tu, mai els d\'una altra persona del tauler.',
    enableEmailNotifications: 'Envia\'m un correu sobre les meves dates de venciment en aquest tauler',
  ...
  board: {
    ...
    archiveAllCards: 'Arxiva totes les targetes',
    renameList: 'Reanomena la llista',
    changeListColor: 'Canvia el color',
    ...
    copyCard: 'Copia la tarja',
    copyCardNamePlaceholder: 'Nom de la còpia',
    targetBoard: 'Tauler',
    targetList: 'Llista',
    noListsOnBoard: 'Aquest tauler encara no té llistes.',
    targetCard: 'Targeta',
    ...
    checklistMenu: 'Menú de la llista de verificació',
    copyChecklist: 'Copia la llista de verificació a una altra targeta',
    copyChecklistTitle: 'Copia la llista de verificació',
    moveChecklist: 'Mou la llista de verificació',
  ...
  timeTracker: {
    ...
    addEntry: 'Afegeix un registre',
    startTitle: 'Comença a comptar',
    addTitle: 'Afegeix un registre de temps',
    editTitle: 'Edita el registre de temps',
    deleteTitle: 'Vols eliminar el registre?',
    deleteConfirmMessage: 'Vols eliminar el temps registrat de "{{name}}"? Aquesta acció no es pot desfer.',
    deleteEntry: 'Elimina el registre',
    editEntry: 'Edita el registre',
    currentTask: 'Comptant ara',
    nothingRunning: 'Ara mateix no s\'està comptant cap tasca.',
    alreadyRunning: 'Ja s\'està comptant una altra tasca. Acaba-la primer.',
    pickCard: 'Primer tria una targeta.',
    timesRequired: "Cal indicar l'hora d'inici i la de final.",
    endBeforeStart: "L'hora de final ha de ser posterior a la d'inici.",
    startTime: 'Inici',
    endTime: 'Final',
    recopyFromCard: 'Torna a copiar les dades d\'una targeta',
    snapshotHint: 'Es van copiar de la targeta en registrar el temps: editar-les aquí només afecta aquest registre.',
    commentHint: 'De què tractava aquesta estona de feina (opcional)',
    year: 'Any',
    month: 'Mes',
    ...
    startColumn: 'Inici',
    endColumn: 'Final',
    durationColumn: 'Durada',
    hoursColumn: 'Hores',
    boardColumn: 'Tauler',
    cardColumn: 'Targeta',
    labelsColumn: 'Etiquetes',
    commentColumn: 'Comentari',
    actionsColumn: 'Accions',
    overlapWarning: 'Aquest registre se superposa amb un altre.',
    noEntries: "No hi ha temps registrat en aquest període.",
    total: '{{entries}} registres · {{duration}} en total',
  },
  common: {
    or: 'o',
